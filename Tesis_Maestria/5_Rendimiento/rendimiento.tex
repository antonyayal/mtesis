...
%El conocerla cantidad de plazos vencidos \textit{$n_{dm}$} es importante para evitar sobrecargar el sistema y darle la oportunidad a todas las tareas de consumir recursos eventualmente. 
