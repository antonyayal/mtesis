...
%	\begin{minipage}[t][0.75\paperheight][t]{0.19\columnwidth}
%		\noindent \vspace{0cm}
%		\begin{center}
%			\includegraphics[scale=0.19]{escudo}
%			\noindent 
%			\includegraphics[scale=0.8]{barra2}
%		\end{center}
%	\end{minipage}}
%	\hfill{}
%	\fcolorbox{white}{white}{
%	\begin{minipage}[t][0.75\paperheight][s]{0.81\columnwidth}
%		\noindent \begin{center}
%			\vspace{0.5cm}
%			\textbf{\Large{\vspace{0cm}UNIVERSIDAD NACIONAL AUTÓNOMA DE MÉXICO}}{\Large{\medskip{}}}\break
%			\makebox[0pt][l]{\rule[4.5pt]{13cm}{2pt}}\rule{13cm}{3pt}
%		\par\end{center}
%		
%		\begin{doublespace}
%			\noindent \begin{center}
%			\textbf{\large{DIVISIÓN DE ESTUDIOS DE POSGRADO}}
...
%		
%		\noindent \begin{center}
%			{\large{``Evaluación de seguridad en sistemas implementados con patrones de seguridad '' }}
%		\par\end{center}{\large \par}
%		
%		\noindent \begin{center}
...
%		
%		\noindent \begin{center}
%			{\large{Dr. Jorge L. Ortega Arjona}}\\
%		\par\end{center}{\large \par}
%
%		\noindent \begin{center}
%			{\large{}}
...
%			{\large{\vspace{7mm}}}{\small{Ciudad de México, Julio de 2019.}}
%		\par\end{flushright}
%	\end{minipage}}
%\end{table}
...
\input{Capitulo3-Descripcion_Novedades.tex}
...
\begin{appendices}
%\chapter{Información del sistema financiero}
\input{ApendiceA.tex}
\end{appendices}
